...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public Country createStudent(Country student) {
    ...
    public boolean deleteStudent(Long studentId) {
        ...
        Country student = studentJpaService.getStudentById(studentId);
        return student != null;
    }

    @Override
    public Country updateStudent(Country student) {
    ...
    @Override
    public Country getStudent(Long studentId) {
